...
let BRAND = {
    ...
    meta: {
        description: 'Кремлёвка — защищённые видеозвонки, обмен сообщениями и демонстрация экрана в браузере.',
        keywords: 'webrtc, видеозвонки, демонстрация экрана, связь, браузер, кремлёвка',
    },
    html: {
        features: true,
        teams: true,
    ...
    whoAreYou: {
        title: 'Кто вы?',
        description: 'Если вы ведущий, авторизуйтесь сейчас.<br />Если вы гость, дождитесь подключения ведущего.',
